...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Detail Pengajuan <?= $ajuan_byid['nama']; ?></h1>
</div>
    ...
    <div class="card-body">
        <table class="table">
            ...
            <tr>
                <td>Nama Lengkap</td>
                <td>:</td>
                <td><?= $ajuan_byid['nama']; ?></td>
            </tr>
            <tr>
                <td>Tempat, Tanggal Lahir</td>
                <td>:</td>
                <td><?= $ajuan_byid['tempatlahir'].', '.date('d F Y,',strtotime($ajuan_byid['tanggallahir'])); ?></td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
                <td><?= $ajuan_byid['jeniskelamin']; ?></td>
            </tr>
            <tr>
                <td>Agama</td>
                <td>:</td>
