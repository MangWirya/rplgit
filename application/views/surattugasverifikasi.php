...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="<?= base_url('pengajuan/surattugasverifikasi/'.$surat->idsurattugas); ?>" method="post">
            <div class="row">
            <div class="col-md-12">
                    <div class="form-group">
                        <label>Judul Tugas</label>
                        <input type="hidden" class="form-control" name="idsurattugas" value="<?= $surat->idsurattugas; ?>">
                        <input type="text" class="form-control" name="judultugas" value="<?= $surat->judultugas; ?>" placeholder="Contoh : Workshop Digital Pengabdian" required readonly>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="alasanizin" rows="5" class="form-control" placeholder="Melakukan Workshop Digital di Graha" value="<?= $surat->alasanizin; ?>" required readonly></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
